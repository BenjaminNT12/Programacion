...
float productQuantity[MAX_MENU_ITEMS] = {0.0}; // Cantidad de producto a dispensar en litros
float productCost[MAX_MENU_ITEMS] = {0.0}; // Costo del producto
float pumpTime[MAX_MENU_ITEMS] = {0.0}; // Tiempo de dispensado del producto
...
void cactus(int pos){
  lcd.createChar(1, CACTUS_11);
  lcd.createChar(2, CACTUS_12);
  lcd.createChar(3, CACTUS_21);
  lcd.createChar(4, CACTUS_22);
  lcd.setCursor(0+pos, 2); lcd.write(1);
  lcd.setCursor(1+pos, 2); lcd.write(2);
